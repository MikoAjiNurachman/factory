...
while ($dataTampil = mysqli_fetch_array($query)) {
  ?>
  <title><?php echo $dataTampil['nama'];?> - Hak Akses</title>
...
<?php
include 'config/koneksi.php';
   $sql = mysqli_query($koneksi,"SELECT * FROM log_session ORDER BY id DESC");
   $id=1;
...
?>
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-6">
          <div class="box box-primary">
            ...
            <div class="col-md-12">
				...
				<form action = "backend/p_e_hakakses.php" method = "post">
        ...
        $query = mysqli_query($koneksi,"SELECT * FROM tbl_aksess WHERE `id` = '$id'"); //get the data that will be updated
        ...
        ?>
              ...
              <div class="form-group">
               ...
               <input type="text" class="form-control" required id = "username" name = "username" value="<?php echo $data[1]; ?>" >
              </div>
             </div>
               ...
               <input type="password" class="form-control" required id = "password" name = "password" value="<?php echo $data[2]; ?>" >
              </div>
              </div>
           ...
           <a href="_hak_akses.php"><input type = "button" value = "Kembali" class = "btn btn-warning" ></input></a>
	...
	include "config/koneksi.php";
  $no = 0;
  $query = mysqli_query($koneksi,"select * from tbl_aksess");
  while ($dataTampil = mysqli_fetch_array($query)) {
    $no++
    ?>
					<tr>
					...
					<td>
        <a href = "_edit_hak_akses.php?id=<?php echo $dataTampil[0]; ?>"   <button type="button"  class="btn btn-primary btn-s" title = "Edit"><i class="fa fa-edit"></i></button></a>
				<a href="backend/p_d_hakakses.php?id=<?php echo $dataTampil[0]; ?>" onclick="return confirm('Apakah anda yakin untuk menghapus : <?php echo $dataTampil[1];?> ?')"<button type="button"  class="btn btn-danger btn-m"><i class="fa fa-trash"></i></button></a>
