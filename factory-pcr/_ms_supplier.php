 ...
 <section class="content">
  <div class="row">
    <div class="col-xs-12">
      ...
      <a href = "_tbh_supplier.php"><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-tambah">
      ...
      <div class="box box-primary">
        ...
        <div class="box-body">
          <div class="col-md-12">
            ...
            <div class="col-xs-6">
              ...
              <?php
              include 'config/koneksi.php';
                 $result = mysqli_query($koneksi_pcr,"SELECT * FROM apmst "); //koneksi2 ini nantinya lookup dgn db_toko yg asli
                 echo '

                 <select name="kodesup1" class = "form-control select2" required id="kodesup" >';
                 echo '<option>Pilih Kode Supllier</option>';
                 while ($row = mysqli_fetch_array($result)) {
                  echo '<option value="'.$row['kodesup'].'">'.$row['kodesup'].' - '.$row['namasup'].'</option>';
                }
                echo '</select>';
                ?>
              </div>
            ...
            <select name="kodesup2" class = "form-control select2" required id="kodesup" >';
            echo '<option>Pilih Kode Supllier</option>';
            while ($row = mysqli_fetch_array($result)) {
             echo '<option value="'.$row['kodesup'].'">'.$row['kodesup'].' - '.$row['namasup'].'</option>';
           }
         ...
         <div class="col-md-6">
          ...
          <div class="form-group">
           ...
           <input type="text" class="form-control" name = "namasup1" id=""  placeholder="Nama Supplier..." >
         </div>
       </div>
       ...
       <div class="col-md-6">
         ...
         <div class="form-group">
          ...
          <input type="text" class="form-control" name = "namasup2" id=""  placeholder="Nama Supplier..." >
        </div>
      </div>
