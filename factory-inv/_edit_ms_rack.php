        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Form Edit & List Data Kode Rack</h3>
            ...
            <div class="col-md-12">
				...
				<form action = "backend/p_e_rack" method = "post">
              ...
              <?php
            	include 'config/koneksi.php';
            	$id = $_GET['nokonter'];
            	$data = mysqli_query($koneksi_inv,"SELECT * FROM ms_rack WHERE `nokonter` = '$id'");
			...
			<div class="col-md-4">
                      ...
                      <input type="text" class="form-control" name = "kdrak" maxlength = "2" value="<?php echo $d['kdrak']; ?>" required>
                      ...
                      <br>
                            ...
                            <a href = "_ms_rack"><input type = "button" value = "Kembali" class = "btn btn-warning" ></input></a>
      ...
      while ($d = mysqli_fetch_array($query)) {
        ...
        ?>
              ...
              <td><?php echo $d[3];?></td>
    					...
    					<td>
    				<a href = "_edit_ms_rack.php?nokonter=<?php echo $d[0]; ?>"   <button type="button"  class="btn btn-primary btn-s" title = "Edit"><i class="fa fa-edit"></i></button></a>
