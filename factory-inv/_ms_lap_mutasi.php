...
while ($dataTampil = mysqli_fetch_array($query)) {
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
         Laporan Data Inventory Mutasi by Kode Item
        ...
        <div class="col-xs-12">
          ...
          <div class="box box-primary">
            ...
            <div class="col-md-12">
				...
				<form action = "_ex_lap_mutasi" method = "post">
   ...
   ?>
      ...
      <label>s.d</label>
                   ...
                   <div class="col-md-5">
                    ...
                    <div class = "col-md-2"><input type = "checkbox" name = "mutasi"> Mutasi 0 dicetak</input></div>
