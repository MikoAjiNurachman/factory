...
while ($dataTampil = mysqli_fetch_array($query)) {
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
         Laporan Data Inventory Beli Akhir by Kode Item
        ...
        <div class="col-xs-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Search Data Beli Akhir Inventory by Kode Item</h3>
            ...
            <div class="col-md-12">
				...
				<form action = "_ex_lap_beliakhir" method = "post">
   ...
   ?>
      ...
      <label>s.d</label>
                   ...
                   <div class="col-md-5">
                          ...
                          <p>&nbsp;</p>
                          <div class="col-sm-2">
                          <label>Range Tanggal Beli</label>
                          </div>
                          <div class="col-md-3">
                                  <div class="form-group">
