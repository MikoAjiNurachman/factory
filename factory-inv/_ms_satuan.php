...
<?php } ?>
        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Form Tambah & List Data Satuan</h3>
            ...
            <div class="col-md-12">
				...
				<form action = "backend/p_t_satuan" method = "post">
			...
			<div class="col-md-4">
                      ...
                      <input type="text" class="form-control" name = "satuan" maxlength = "5" placeholder="Input Nama Satuan... ( max : 4 character)" required>
  ...
  <div class="col-md-8">
    <form action="backend/p_d_b_satuan.php" method="post">
      ...
      while ($d = mysqli_fetch_array($query)) {
        ...
        ?>
              ...
              <td><?php echo $d[3];?></td>
    				...
    				<a href = "backend/p_d_satuan?nokonter=<?php echo $d[0]; ?>" onclick="return confirm('Apakah anda yakin untuk menghapus satuan inventory : <?php echo $d[1];?> ?')" <button type="button"  class="btn btn-danger btn-s"><i class="fa fa-trash"></i></button></a>
    					</td>
                  ...
                  <input type="submit" onclick="return confirm('Apakah anda yakin untuk menghapus data satuan yang terpilih ?')" value="Hapus" name="submit" /><br />
                  </form>
         </div>
